...
/* structure definitions for \impcore 943a */
struct Component {
    Exp exp;
    Explist exps;
    Name name;
...
void bindval(Name name, Value val, Valenv env); // Will need these functions to bind a function/value
void bindfun(Name name, Fun   fun, Funenv env); // Will need these functions to bind a function/value
