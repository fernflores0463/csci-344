...
(class XVectorTester Object
  ...
  (method test-at-ifAbsent () (locals tmp)
    ...
    (do: '(0 1 2 3 4 5) (block (i)
      (set tmp i)
      (print left-paren) (print 'at:ifAbsent:) (print space) (print name) (print space) (print tmp) (print space) (print left-curly) (print 'false) (print right-curly) (print right-paren) (print space) (print '=>) (print space) (println (at:ifAbsent: xv tmp {false}))))
    (do: '(3 30) (block (i)
      (set tmp (- (raisedToInteger: 2 i) 1))
      (print left-paren) (print 'at:ifAbsent:) (print space) (print name) (print space) (print tmp) (print space) (print left-curly) (print 'false) (print right-curly) (print right-paren) (print space) (print '=>) (print space) (println (at:ifAbsent: xv tmp {false}))
      (set tmp (raisedToInteger: 2 i))
    ...
    (do: '(0 1 2 3 4 5) (block (i)
      (set tmp i)
      (print left-paren) (print 'at:ifAbsent:) (print space) (print name) (print space) (print tmp) (print space) (print left-curly) (print 'true) (print right-curly) (print right-paren) (print space) (print '=>) (print space) (println (at:ifAbsent: xv tmp {true}))))
    (do: '(3 30) (block (i)
      (set tmp (- (raisedToInteger: 2 i) 1))
      (print left-paren) (print 'at:ifAbsent:) (print space) (print name) (print space) (print tmp) (print space) (print left-curly) (print 'true) (print right-curly) (print right-paren) (print space) (print '=>) (print space) (println (at:ifAbsent: xv tmp {true}))
      (set tmp (raisedToInteger: 2 i))
  ...
  (method test-do () (locals tmp)
    ...
    (ifTrue: (< size 4096) {
      ...
      (ifTrue: isNum {
        ...
        (print left-paren) (print 'detect:ifNone:) (print space) (print name) (print space) (print 'negative) (print right-paren) (print space) (print '=>) (print space) (println (detect:ifNone: xv (block (x) (negative x)) {false}))
        (print left-paren) (print 'detect:ifNone:) (print space) (print name) (print space) (print 'nonnegative) (print right-paren) (print space) (print '=>) (print space) (println (detect:ifNone: xv (block (x) (nonnegative x)) {false}))
        (print left-paren) (print 'detect:ifNone:) (print space) (print name) (print space) (print 'strictlyPositive) (print right-paren) (print space) (print '=>) (print space) (println (detect:ifNone: xv (block (x) (strictlyPositive x)) {false}))
        (print left-paren) (print 'detect:ifNone:) (print space) (print name) (print space) (print 'negative) (print right-paren) (print space) (print '=>) (print space) (println (detect:ifNone: xv (block (x) (negative x)) {true}))
        (print left-paren) (print 'detect:ifNone:) (print space) (print name) (print space) (print 'nonnegative) (print right-paren) (print space) (print '=>) (print space) (println (detect:ifNone: xv (block (x) (nonnegative x)) {true}))
        (print left-paren) (print 'detect:ifNone:) (print space) (print name) (print space) (print 'strictlyPositive) (print right-paren) (print space) (print '=>) (print space) (println (detect:ifNone: xv (block (x) (strictlyPositive x)) {true}))
        })})
     unit)
  (method test-sum ()
    (print 'Testing) (print space) (println name)
